...
export function VoxelHero({ name, role }: VoxelHeroProps) {
  ...
  return (
    <section className="relative h-[136svh] bg-[#111b31]">
      <div className="sticky top-0 h-[100svh] overflow-hidden">
        <motion.div className="absolute inset-0" style={{ opacity: imageOpacity }}>
          ...
          <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(6,11,25,.58)_0%,rgba(7,12,25,.08)_38%,rgba(7,12,24,.38)_72%,#09090b_100%)]" />
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_42%,transparent_0%,rgba(9,13,30,.18)_58%,rgba(4,7,16,.56)_100%)]" />
        </motion.div>
        ...
        <motion.div className="relative mx-auto flex h-full max-w-[1600px] flex-col justify-end px-6 pb-10 pt-32 md:px-10 md:pb-12" style={{ opacity: contentOpacity, y: contentY }}>
          <div className="mb-auto flex items-center justify-between font-mono text-[10px] uppercase tracking-[.16em] text-white/65">
          ...
          <div>
            <p className="mb-5 max-w-sm text-sm leading-relaxed text-white/78 md:mb-7 md:text-base">
              {role}. I make useful things feel a little more alive.
            </p>
          ...
          <motion.div className="mt-10 origin-left border-t border-white/35 pt-4 md:mt-14 md:flex md:items-center md:justify-between" style={{ scaleX: lineScale }}>
            <p className="max-w-md text-sm leading-relaxed text-white/68">A personal collection of products, experiments, and ideas built with curiosity and care.</p>
            <a href="#work" className="group mt-5 inline-flex items-center gap-3 font-mono text-[10px] uppercase tracking-[.14em] text-white md:mt-0">
        ...
        <div className="pointer-events-none absolute bottom-7 left-1/2 hidden -translate-x-1/2 items-center gap-3 font-mono text-[9px] uppercase tracking-[.18em] text-white/55 md:flex">
